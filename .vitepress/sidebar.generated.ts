export const generatedSidebar = [
  ...
  },
  {
    ...
    items: [
      ...
      { text: "今回の内容", link: "/text/chapter-1/02" },
      { text: "1. 良いコードとは", link: "/text/chapter-1/03" },
      { text: "2. 命名規則を守る", link: "/text/chapter-1/04" },
      { text: "3. コメントを正しく活用する", link: "/text/chapter-1/05" },
      { text: "4. アクセスレベルを意識する", link: "/text/chapter-1/06" },
      { text: "5. 一つのメソッドに詰め込まない", link: "/text/chapter-1/07" },
      { text: "6. ネストを回避する", link: "/text/chapter-1/08" },
      { text: "7. 同じことを何度も書かない", link: "/text/chapter-1/09" },
      { text: "8. 間違った共通化をしない", link: "/text/chapter-1/10" },
      { text: "9. switch文を回避する", link: "/text/chapter-1/11" },
      { text: "10. フラグ引数を使わない", link: "/text/chapter-1/12" },
      { text: "11. 車輪の再発明をしない", link: "/text/chapter-1/13" },
      { text: "12. 読み取り専用のコレクションを渡す", link: "/text/chapter-1/14" },
      { text: "13. デッドコードを消す", link: "/text/chapter-1/15" },
      { text: "14. 今いらないものは実装しない", link: "/text/chapter-1/16" },
      { text: "15. マジックナンバーを消す", link: "/text/chapter-1/17" },
      { text: "16. 再代入をしない", link: "/text/chapter-1/18" },
      { text: "17. nullを回避する", link: "/text/chapter-1/19" },
      { text: "参考文献", link: "/text/chapter-1/20" },
    ]
  },
  {
    text: '第2回 クラス設計',
